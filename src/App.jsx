    ...
    <>
      ...
      <div className="tc-wrap" dir="ltr">
        ...
        <div className="tc-messages">
          <h3 className="tc-h3">My Messages <span className="tc-count">{messages.length}</span></h3>
          {messages.length === 0 && <p className="tc-empty">No messages yet. Seal your first one above.</p>}
          {messages.map((m, i) => {
  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .tc-count {
        background: #3a2c1f; color: #f5c97a;
        font-family: 'Nunito'; font-size: 0.85rem; font-weight: 700;
      ...
      .tc-input:focus {
        outline: none; border-color: #f5c97a;
        box-shadow: 0 0 0 3px rgba(245,201,122,0.15);
      }
      ...
      .tc-pulse {
        width: 10px; height: 10px; border-radius: 50%; background: #ff5247;
      ...
      .tc-msg-card {
        position: relative;
        background: #241b14; border: 1px solid #3a2c1f; border-radius: 14px;
      ...
      .tc-delete {
        ...
        background: transparent; border: none; color: #6b5a48;
